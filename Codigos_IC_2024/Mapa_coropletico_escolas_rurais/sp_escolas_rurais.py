# -*- coding: utf-8 -*-
"""ESCOLAS RURAIS EM SP - MAPA

Automatically generated by Colab.

Original file is located at
    https://colab.research.google.com/drive/1FS01LGJhzFGd-c_YlYxodHgBz_x7-p_M
"""
...
rural = pd.read_excel('RURAL EM SP.xlsx')
...
estado = gpd.read_file('SP_Municipios_2022.zip')
...
rural_por_cidade = pd.merge(estado,rural,left_on='NM_MUN',right_on='CIDADES',how='left',sort=True)
rural_por_cidade.head()

#criando a coluna do percentual de labs de ciencias por cidade
rural_por_cidade['percentual_rural'] = rural_por_cidade['QTD ESCOLAS RURAIS']/1
