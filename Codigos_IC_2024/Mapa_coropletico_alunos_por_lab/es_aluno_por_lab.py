...
Original file is located at
    https://colab.research.google.com/drive/1I5fp3nTy74K3imDbGvXvl3ctJNY9g7wX
"""
...
import geopandas as gpd
estado = gpd.read_file('ES_Municipios_2022.zip')
...
mapa.save('mapa_aluno_lab_ES.html')

# Para baixar o arquivo no Google Colab
from google.colab import files
files.download('mapa_aluno_lab_ES.html')
