...
Original file is located at
    https://colab.research.google.com/drive/19C-GhJe59pMmYR3vxBb18tiywPC2ESsN
"""
...
import geopandas as gpd
estado = gpd.read_file('PR_Municipios_2022.zip')
...
mapa.save('mapa_aluno_lab_PR.html')

# Para baixar o arquivo no Google Colab
from google.colab import files
files.download('mapa_aluno_lab_PR.html')
